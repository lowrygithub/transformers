...
class InputFeaturesDssm:
    ...
    label_b: Optional[Union[int, float]] = None
...
@dataclass(frozen=True)
class InputFeaturesWithNegDssm:
    """
    A single set of features of data.
    Property names are the same names as the corresponding inputs to a model.
    ...
    token_type_ids_b: Optional[List[int]] = None
    label_b: Optional[Union[int, float]] = None
    input_ids_c: Optional[List[int]] = None
    attention_mask_c: Optional[List[int]] = None
    token_type_ids_c: Optional[List[int]] = None
    label_c: Optional[Union[int, float]] = None
    input_ids_d: Optional[List[int]] = None
    attention_mask_d: Optional[List[int]] = None
    token_type_ids_d: Optional[List[int]] = None
    label_d: Optional[Union[int, float]] = None
    def to_json_string(self):
        """Serializes this instance to a JSON string."""
        return json.dumps(dataclasses.asdict(self)) + "\n"
